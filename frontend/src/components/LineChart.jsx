    ...
    return (
        <div className="p-4 shadow-lg bg-white rounded-xl flex flex-col items-center" style={{ height, width }}>
            ...
            <div className="rounded-lg bg-gray-50 p-2 w-full h-full">
                {loading ? <div className="font-bold flex items-center justify-center h-full text-2xl"><p>Loading...</p></div> : <Line data={data} options={options} style={{ height: graphHeight, width: graphWidth }} />}
